...
Объекты идентичны, если ссылаются на один и тот же объект из кэша CPython.
У объектов, имеющих равные значения, могут быть разные объекты-ссылки из кэша CPython.
## 3)
